...
void main() {
  runApp(const privityPolicyPage());
}

class privityPolicyPage extends StatefulWidget {
  const privityPolicyPage({super.key});

  @override
  State<privityPolicyPage> createState() => _privityPolicyPage();
}

class _privityPolicyPage extends State<privityPolicyPage>{
