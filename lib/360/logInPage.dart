...
class _logInPage extends State<logInPage>{
          ...
          bool isAgree = false;
          TextEditingController btnControling = TextEditingController();
    ...
    return MaterialApp(
      ...
      home: LayoutBuilder(
        builder: (context, constraints){
          ...
          double head1 = devicewidthPage * 0.06;
          double head2 = devicewidthPage * 0.05;
          double normalText = devicewidthPage * 0.037;
          double smallText = devicewidthPage * 0.03;
