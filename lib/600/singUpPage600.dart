...
void main(){
  runApp(signUpPage600());
}

class signUpPage600 extends StatefulWidget{

  @override
  signUpPage600({super.key});

  @override
  State<signUpPage600> createState() => _signUpPage600();
}

class _signUpPage600 extends State<signUpPage600> {
      ...
      home: Scaffold(
        ...
        body: LayoutBuilder(
          builder: (context, constraints){
            ...
            double head1 = devicewidthPage * 0.05;
            double head2 = devicewidthPage * 0.03;
            double normalText = devicewidthPage * 0.025;
