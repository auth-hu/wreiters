// ignore_for_file: prefer_const_constructors_in_immutables, camel_case_types, non_constant_identifier_names
...
class logInPage600 extends StatefulWidget {
  @override
  logInPage600({super.key});

  @override
  State<logInPage600> createState() => _logInPage600State();
}

class _logInPage600State extends State<logInPage600> {
   /* Them Section Start */
          bool DarkThem = true;
          /* Them Section End */
    ...
    return MaterialApp(
      ...
      home: LayoutBuilder(
        builder: (context, constraints){
          ...
          double head1 = devicewidthPage * 0.04;
          double head2 = devicewidthPage * 0.03;
          double normalText = devicewidthPage * 0.027;
          double smallText = devicewidthPage * 0.02;
