...
void main() {
  runApp(const privicyPolicyPage900());
}

class privicyPolicyPage900 extends StatefulWidget {
  const privicyPolicyPage900({super.key});

  @override
  State<privicyPolicyPage900> createState() => _privicyPolicyPage900();
}

class _privicyPolicyPage900 extends State<privicyPolicyPage900>{
              ...
              body: Column(
                ...
                /* Back Button Section End */
                  ...
                  Container(
                    ...
                    height: devicewidth >= 1087 ? 400 : 450,
