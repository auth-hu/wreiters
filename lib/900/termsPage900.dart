...
void main() {
  runApp(const termsPage900());
}

class termsPage900 extends StatefulWidget {
  const termsPage900({super.key});

  @override
  State<termsPage900> createState() => _termsPage900();
}

class _termsPage900 extends State<termsPage900>{
